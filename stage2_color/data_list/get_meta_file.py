...
if __name__ == '__main__':
    ...
    parser.add_argument('--output-name', type=str, default='DIV2K_ddcolor.txt', help='Path output file.')
    parser.add_argument('--data-path', type=str, default='Y:/teacherguo/DDColor-master/assets/DIV2K_ddcolor', help='Path to dataset')
